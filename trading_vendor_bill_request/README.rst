...
============================
Trading Vendor Bill Request
============================

The module 'trading_vendor_bill_request' inherit the 'account_invoice' model to add field to compute the
total quantity of invoiced products. It allows user to generate the purchase bill request, and list the product,
quantity, total price of each invoice line.
