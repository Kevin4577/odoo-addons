...
=========================================
Trading Vendor Incoming Products Printout
=========================================

The new module 'trading_vendor_incoming_products_printout' inherit the model 'stock.move',
and add necessary fields for each stock move of related incoming products for each purchase lines.
It allows user to generate incoming products report for all products, which was still waiting for receiving.
