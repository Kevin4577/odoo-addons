...
class TestCommercialInvoiceReport(common.TransactionCase):
    ...
    def setUp(self):
        ...
        self.trading_invoice_model = self.env['trading.sale']
    ...
    def test_get_product_sale_list_without_invoice(self):
    ...
    def test_get_product_sale_list_witout_sale_order(self):
        with self.assertRaises(ValidationError):
