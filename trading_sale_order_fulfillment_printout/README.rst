...
=====================================
Trading Sale Order Fulfillment Report
=====================================

The module 'trading_sale_order_fulfillment_printout' allow user to generate the trading
sale order fulfillment report with the format of 'xlsx' from sale order line.
