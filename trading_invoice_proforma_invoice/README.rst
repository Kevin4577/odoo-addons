...
================================
Trading Invoice Proforma Invoice
================================

The new module 'trading_invoice_proforma_invoice' generate the xls or ods report from ods template file.
This report show each order lines of product inside account invoice,
which was required to delivery to the customer.
