...
==========================
Trading Stock Packing List
==========================

The new module 'trading_stock_packing_list' generate the xls or ods report
from ods template file. This report show lot detail of each product of
delivey order, which related to this account invoice.
