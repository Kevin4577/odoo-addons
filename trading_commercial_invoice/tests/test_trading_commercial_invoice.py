...
from odoo.addons.trading_commercial_invoice.models.\
    trading_commercial_invoice import render_template_with_data
from odoo.tests import common
from odoo.exceptions import ValidationError


class TestTradingCommercialInvoice(common.TransactionCase):

    def setUp(self):
        super(TestTradingCommercialInvoice, self).setUp()
        self.report_xml_id = self.env.ref('trading_commercial_invoice.'
