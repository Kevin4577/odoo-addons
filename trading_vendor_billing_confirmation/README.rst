...
====================================
Trading Vendor Billing Confirmation
====================================

The module 'trading_vendor_billing_confirmation' will inherit the model 'account.invoice.line', and add reference
of product, vendor, customer product code. It allows user to generate billing confirmation report, based on the product,
invoiced quantity, total price of each account invoice line
