...
=================================
Trading Vendor Delay Rate Summary
=================================

The new module 'trading_vendor_delay_rate_summary' allows user to generate delay rate of vendor purchase
order for each purchase order lines.
