...
=====================================
Trading Stock Delivery Note By Pallet
=====================================

This module generate Trading Stock Delivery Note By Pallet for multi-delivery
orders, and supported by the OCA report engine module named 'report_py3o'.
Order quantity, Delivery quantity, and carton quantity of each sale order
lines.
