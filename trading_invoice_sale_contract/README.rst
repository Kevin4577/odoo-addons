...
=============================
Trading Invoice Sale Contract
=============================

The new module 'trading_invoice_sale_contract' generate the xls or ods report from ods template file.
This report show each product information inside sale order,
