...
==================================
Trading Stock Delivery Note By lot
==================================

This module generate Trading Stock Delivery Note By Lot for multi-delivery orders,
and supported by the OCA report engine module named 'report_py3o'.
Carton quantity and weight of each lots in those delivery orders be provided to display
in this report with the specific format.
