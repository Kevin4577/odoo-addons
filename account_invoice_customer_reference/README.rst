...
==================================
Account Invoice Customer Reference
==================================

The new module 'account_invoice_customer_reference' specifics the char field
'internal_reference' for account invoice model, and allow customer to maintain
it manually.
