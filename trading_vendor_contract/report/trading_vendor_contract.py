...
@py3o_report.py3o_report_extender(
    report_xml_id='trading_vendor_contract.trading_vendor_contract_py3o')
def render_report_with_data(report_xml_id, data):
    """This function get order lines from purchase orders, and sum the
    quantity and price amount, in order to render the ods template with
    necessary data."""
