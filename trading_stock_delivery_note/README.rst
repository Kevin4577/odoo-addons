...
===========================
Trading Stock Delivery Note
===========================

The new module 'trading_stock_delivery_note' generate the xls or ods report from ods template file.
This report show the order quantity and the delivery quantity of each lines inside sale order,
